...
function About() {
  ...
  const [timediff, setTimediff] = useState({'dob': 0, 'store': 0, 'study': 0})

  // useEffect(() => {
  //   setTimediff({'dob': Date.now() - 500919338, 'store': Date.now() - 1627974000, 'study': Date.now() - 1599048232})
  // }, [Math.round(Date.now())]);

  useEffect(() => {
    const interval = setInterval(() => {
      setTimediff({
        'dob': Math.round(new Date().getTime()/1000) - 500919338,
      'store': Math.round(new Date().getTime()/1000) - 1627974000,
      'study': Math.round(new Date().getTime()/1000) - 1599048232
    })
    }, 100);
  ...
  return (
    ...
    <Container>
      <Row>
        <Col md={{span: 6, offset: 3}} className="full-page">
          <Card>
            <Card.Img variant="top" src="public/uploads/images/moje.jpg" />
            <Card.Header className="fw-bold fs-4">Cześć, jestem Michał!</Card.Header>
            <Card.Body>
              Urodziłem się {timediff['dob']} sekund temu.<br/>
              Zawodowo, zajmuję sie prowadzeniem pewnego sklepu (zaczęło się to około {(timediff['store']/60).toFixed(0)} minut temu) i trwa do dzisiaj.<br />
              Studentem jestem raptem od {(timediff['study']/3600).toFixed(0)} godzin a zatem jedynie przez {(Math.round(((timediff['study'] * 100) / timediff['dob']) * 10000000)/10000000).toFixed(7)}% swojego życia 🤓.<br/>
              Co planuję dalej? jedno jest pewne: na tym nie poprzestanę!
            </Card.Body>
            <Card.Footer>
              Śledź mnie na:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <a href="https://www.facebook.com/mwojczewski/">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
              </a>&nbsp;&nbsp;
              <a href="https://www.instagram.com/mwojczewski/">
              ...
              <a href="https://www.github.com/mwojczewski/">
